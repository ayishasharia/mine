...
//fuction to create a set for an object
void makeset(int a)
...
//fuction to return pointer of the representative
//containing x
...
//fuction to display a set
void dispaly_set(int a)
{
struct rep * r;
r=find(a);
...
printf("find(20)=%p",find(20));
printf("find(30)=%p",find(300));
printf("find(40)=%p",find(40));
unionset(10,20);
printf("\nAfter union of 10 and 20 find(20)=%p",find(20));
unionset(30,40);
printf("\nAfter union of 30 and 40 find(40)=%p",find(40));
unionset(20,40);
printf("\nAfter union of set containing 20 and 40 find(20)=%p",find(40));
}
